...
# Set specific network interface configurations (replace 'enp1s0' with your actual interface name)
INTERFACE="enp1s0"
...
echo "Internal IP = $INTERNAL_IP. External subnet for IPv6 = $EXTERNAL_SUBNET"
